...
func (o *DeleteOneNoContent) Error() string {
	return fmt.Sprintf("[DELETE /{id}][%d] deleteOneNoContent ", 204)
}
...
func (o *DeleteOneDefault) Error() string {
	return fmt.Sprintf("[DELETE /{id}][%d] deleteOne default  %+v", o._statusCode, o.Payload)
}

func (o *DeleteOneDefault) GetPayload() *restmodels.Error {
	return o.Payload
}
