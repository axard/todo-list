...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		TodosCreateOneHandler: todos.CreateOneHandlerFunc(func(params todos.CreateOneParams) middleware.Responder {
...
type TodoListAPI struct {
	...
	// TodosCreateOneHandler sets the operation handler for the create one operation
...
func (o *TodoListAPI) Validate() error {
	...
	if o.TodosCreateOneHandler == nil {
		unregistered = append(unregistered, "todos.CreateOneHandler")
	}
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["POST"][""] = todos.NewCreateOne(o.context, o.TodosCreateOneHandler)
	...
	o.handlers["GET"][""] = todos.NewReadTodos(o.context, o.TodosReadTodosHandler)
