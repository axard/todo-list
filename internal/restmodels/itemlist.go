...
// Validate validates this itemlist
...
func (m *Itemlist) validateItems(formats strfmt.Registry) error {
...
func (m *Itemlist) validateTotal(formats strfmt.Registry) error {
